...
var require_browser = __commonJS({
  "node_modules/os-browserify/browser.js"(exports2) {
    init_shim();
  ...
  "node_modules/dotenv/lib/main.js"(exports2, module2) {
    ...
    function _vaultPath(options) {
      ...
      if (options && options.path && options.path.length > 0) {
        ...
        possibleVaultPath = path.resolve(import_process.default.cwd(), ".env.vault");
      }
    ...
    function configDotenv(options) {
      const dotenvPath = path.resolve(import_process.default.cwd(), ".env");
      let encoding = "utf8";
